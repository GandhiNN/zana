...
/// Attempts to serialization of the given struct
/// into JSON and writing it into a file.
...
/// Attempts reading a file and deserializing its
/// contents to instance of type `T`
